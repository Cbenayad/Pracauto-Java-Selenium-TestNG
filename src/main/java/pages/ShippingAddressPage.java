...
public class ShippingAddressPage extends BaseTools {
    private By pageHeader = By.xpath("//h3[contains(text(),'Shipping Address')]");
    private By firstNameField = By.xpath("//input[@id='shipping_first_name']");
    private By lastNameField = By.xpath("//input[@id='shipping_last_name']");
    private By countryDiv = By.xpath("//div[@id='s2id_shipping_country']");
    private By addressField = By.xpath("//input[@id='shipping_address_1']");
    private By cityField = By.xpath("//input[@id='shipping_city']");
    private By postCodeField = By.xpath("//input[@id='shipping_postcode']");
    ...
    public void FillShippingAddressForm(String firstName, String lastName, String country, String address, String postCode, String city) {
